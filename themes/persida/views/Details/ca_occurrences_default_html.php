...
{{{<ifcount code="ca_objects" min="1">
			...
			<script type="text/javascript">
				jQuery(document).ready(function() {
					jQuery("#browseResultsContainer").load("<?php print caNavUrl($this->request, '', 'Browse', 'objects', array('facet' => 'exhibition_facet', 'id' => $vn_id), array('dontURLEncodeParameters' => true)); ?>", function() {
